...
export default function StoryWindow({generatedText, handleStoryOnChange}: StoryWindowProps) {
  ...
  <>
    ...
    {inputModeActive? 
        ...
        <label 
          ...
          <textarea className='mt-4 overflow-hidden outline-none p-4 rounded-lg text-left w-full min-h-[3rem] font-semibold bg-slate-50 border border-black'
            ref={textareaRef}
            name="generated text"
            id="generated text"
            value={generatedText}
